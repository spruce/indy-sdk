...
fn _create_and_store_my_did(
    ...
    ErrorCode::from(unsafe {
        did::indy_create_and_store_my_did(command_handle, wallet_handle, did_json.as_ptr(), cb)
    })
}
...
fn _replace_keys_apply(
    ...
    ErrorCode::from(unsafe {
        did::indy_replace_keys_apply(command_handle, wallet_handle, tgt_did.as_ptr(), cb)
    })
}
...
fn _store_their_did(
    ...
    ErrorCode::from(unsafe {
        did::indy_store_their_did(command_handle, wallet_handle, identity_json.as_ptr(), cb)
    })
}
...
fn _key_for_did(
    ...
    ErrorCode::from(unsafe {
        did::indy_key_for_did(command_handle, pool_handle, wallet_handle, did.as_ptr(), cb)
    })
}
...
fn _key_for_local_did(
    ...
    ErrorCode::from(unsafe {
        did::indy_key_for_local_did(command_handle, wallet_handle, did.as_ptr(), cb)
    })
}
...
fn _get_endpoint_for_did(
    ...
    ErrorCode::from(unsafe {
        did::indy_get_endpoint_for_did(command_handle, wallet_handle, pool_handle, did.as_ptr(), cb)
    })
}
...
fn _get_did_metadata(
    ...
    ErrorCode::from(unsafe {
        did::indy_get_did_metadata(command_handle, wallet_handle, tgt_did.as_ptr(), cb)
    })
}
...
fn _get_my_did_with_metadata(
    ...
    ErrorCode::from(unsafe {
        did::indy_get_my_did_with_meta(command_handle, wallet_handle, my_did.as_ptr(), cb)
    })
}
...
fn _abbreviate_verkey(
    ...
    ErrorCode::from(unsafe {
        did::indy_abbreviate_verkey(command_handle, tgt_did.as_ptr(), verkey.as_ptr(), cb)
    })
}
