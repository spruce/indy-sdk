...
use ffi::ledger;
use ffi::{ResponseStringCB, ResponseStringStringCB, ResponseStringStringU64CB};
...
pub async fn sign_and_submit_request(
    ...
    let err = _sign_and_submit_request(
        command_handle,
        pool_handle,
        wallet_handle,
        submitter_did,
...
fn _submit_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_submit_request(command_handle, pool_handle, request_json.as_ptr(), cb)
    })
}
...
pub async fn submit_action(
    ...
    request_json: &str,
    nodes: Option<&str>,
    wait_timeout: Option<i32>,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();

    let err = _submit_action(
        command_handle,
        pool_handle,
        request_json,
        nodes,
...
fn _submit_action(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_submit_action(
            command_handle,
            pool_handle,
            request_json.as_ptr(),
            opt_c_ptr!(nodes, nodes_str),
            wait_timeout.unwrap_or(-1),
            cb,
        )
    })
}
...
fn _multi_sign_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_multi_sign_request(
            command_handle,
            wallet_handle,
            submitter_did.as_ptr(),
            request_json.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_get_ddo_request(
...
fn _build_get_ddo_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_ddo_request(
            command_handle,
...
/// # Returns
/// Request result as json.
pub async fn build_get_nym_request(
    submitter_did: Option<&str>,
    target_did: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
///                             201 - NETWORK_MONITOR
/// }
pub async fn parse_get_nym_response(get_nym_response: &str) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _parse_get_nym_response(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_parse_get_nym_response(command_handle, get_nym_response.as_ptr(), cb)
    })
}
...
/// # Returns
/// Request result as json.
pub async fn build_get_txn_request(
    submitter_did: Option<&str>,
...
fn _build_get_txn_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_txn_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
...
fn _build_attrib_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_attrib_request(
            command_handle,
            submitter_did.as_ptr(),
            target_did.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_get_attrib_request(
    submitter_did: Option<&str>,
    target_did: &str,
    raw: Option<&str>,
    hash: Option<&str>,
    ...
    let err = _build_get_attrib_request(
        command_handle,
        submitter_did,
        target_did,
        raw,
...
fn _build_get_attrib_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_attrib_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            target_did.as_ptr(),
            opt_c_ptr!(raw, raw_str),
...
/// # Returns
/// Request result as json.
pub async fn build_schema_request(submitter_did: &str, data: &str) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_schema_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_schema_request(command_handle, submitter_did.as_ptr(), data.as_ptr(), cb)
    })
}
...
/// # Returns
/// Request result as json.
pub async fn build_get_schema_request(
    submitter_did: Option<&str>,
    id: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_get_schema_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_schema_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            id.as_ptr(),
            cb,
...
///     ver: Version of the Schema json
/// }
pub async fn parse_get_schema_response(
...
/// # Returns
/// Request result as json.
pub async fn build_cred_def_request(submitter_did: &str, data: &str) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_cred_def_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_cred_def_request(
            command_handle,
            submitter_did.as_ptr(),
            data.as_ptr(),
            cb,
...
/// # Returns
/// Request result as json.
pub async fn build_get_cred_def_request(
    submitter_did: Option<&str>,
    id: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_get_cred_def_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    id: &str,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_cred_def_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            id.as_ptr(),
            cb,
...
/// }
pub async fn parse_get_cred_def_response(
...
fn _parse_get_cred_def_response(
    command_handle: CommandHandle,
    get_cred_def_response: &str,
    cb: Option<ResponseStringStringCB>,
) -> ErrorCode {
...
/// # Returns
/// Request result as json.
pub async fn build_node_request(
    submitter_did: &str,
    target_did: &str,
    data: &str,
) -> Result<String, IndyError> {
...
fn _build_node_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_node_request(
            command_handle,
            submitter_did.as_ptr(),
            target_did.as_ptr(),
            data.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_get_validator_info_request(submitter_did: &str) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_get_validator_info_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    cb: Option<ResponseStringCB>,
) -> ErrorCode {
...
/// # Returns
/// Request result as json.
pub async fn build_pool_config_request(
    submitter_did: &str,
    writes: bool,
    force: bool,
) -> Result<String, IndyError> {
...
fn _build_pool_config_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_pool_config_request(
            command_handle,
            submitter_did.as_ptr(),
            writes,
            force,
...
/// # Returns
/// Request result as json.
pub async fn build_pool_restart_request(
    submitter_did: &str,
    action: &str,
    datetime: Option<&str>,
) -> Result<String, IndyError> {
...
fn _build_pool_restart_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    action: &str,
    datetime: Option<&str>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_pool_restart_request(
            command_handle,
            submitter_did.as_ptr(),
            action.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_pool_upgrade_request(
    submitter_did: &str,
    name: &str,
    version: &str,
    action: &str,
    ...
    let err = _build_pool_upgrade_request(
        command_handle,
        submitter_did,
        name,
        version,
...
fn _build_pool_upgrade_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    name: &str,
    version: &str,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_pool_upgrade_request(
            command_handle,
            submitter_did.as_ptr(),
            name.as_ptr(),
            version.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_revoc_reg_def_request(
    submitter_did: &str,
    data: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_revoc_reg_def_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    data: &str,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_revoc_reg_def_request(
            command_handle,
            submitter_did.as_ptr(),
            data.as_ptr(),
            cb,
...
/// # Returns
/// Request result as json.
pub async fn build_get_revoc_reg_def_request(
    submitter_did: Option<&str>,
    id: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_get_revoc_reg_def_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    id: &str,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_revoc_reg_def_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            id.as_ptr(),
            cb,
...
///     "ver": string - version of revocation registry definition json.
/// }
pub async fn parse_get_revoc_reg_def_response(
...
fn _parse_get_revoc_reg_def_response(
    command_handle: CommandHandle,
    get_revoc_reg_def_response: &str,
    cb: Option<ResponseStringStringCB>,
) -> ErrorCode {
    ...
    ErrorCode::from(unsafe {
        ledger::indy_parse_get_revoc_reg_def_response(
            command_handle,
...
/// # Returns
/// Request result as json.
pub async fn build_revoc_reg_entry_request(
    submitter_did: &str,
    ...
    let err = _build_revoc_reg_entry_request(
        command_handle,
        submitter_did,
        revoc_reg_def_id,
        rev_def_type,
...
fn _build_revoc_reg_entry_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    revoc_reg_def_id: &str,
    rev_def_type: &str,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_revoc_reg_entry_request(
            command_handle,
            submitter_did.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_get_revoc_reg_request(
    submitter_did: Option<&str>,
    revoc_reg_def_id: &str,
    timestamp: i64,
) -> Result<String, IndyError> {
    ...
    let err = _build_get_revoc_reg_request(
        command_handle,
        submitter_did,
        revoc_reg_def_id,
        timestamp,
...
fn _build_get_revoc_reg_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    revoc_reg_def_id: &str,
    timestamp: i64,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_revoc_reg_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            revoc_reg_def_id.as_ptr(),
            timestamp,
...
/// }
pub async fn parse_get_revoc_reg_response(
    ...
    ResultHandler::str_str_u64(command_handle, err, receiver).await
}

fn _parse_get_revoc_reg_response(
    command_handle: CommandHandle,
    get_revoc_reg_response: &str,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_parse_get_revoc_reg_response(
            command_handle,
...
/// # Returns
/// Request result as json.
pub async fn build_get_revoc_reg_delta_request(
    submitter_did: Option<&str>,
    revoc_reg_def_id: &str,
    from: i64,
    to: i64,
    ...
    let err = _build_get_revoc_reg_delta_request(
        command_handle,
        submitter_did,
        revoc_reg_def_id,
        from,
...
fn _build_get_revoc_reg_delta_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    revoc_reg_def_id: &str,
    from: i64,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_revoc_reg_delta_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            revoc_reg_def_id.as_ptr(),
            from,
...
/// }
pub async fn parse_get_revoc_reg_delta_response(
...
fn _parse_get_revoc_reg_delta_response(
    command_handle: CommandHandle,
    get_revoc_reg_delta_response: &str,
    cb: Option<ResponseStringStringU64CB>,
) -> ErrorCode {
    ...
    ErrorCode::from(unsafe {
        ledger::indy_parse_get_revoc_reg_delta_response(
            command_handle,
...
/// }
pub async fn get_response_metadata(response: &str) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _get_response_metadata(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_get_response_metadata(command_handle, response.as_ptr(), cb)
    })
}
...
/// # Returns
/// Request result as json.
pub async fn build_auth_rule_request(
    submitter_did: &str,
    txn_type: &str,
    action: &str,
    field: &str,
    ...
    let err = _build_auth_rule_request(
        command_handle,
        submitter_did,
        txn_type,
        action,
...
fn _build_auth_rule_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_auth_rule_request(
            command_handle,
            submitter_did.as_ptr(),
            txn_type.as_ptr(),
            action.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_auth_rules_request(
    submitter_did: &str,
    data: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_auth_rules_request(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_auth_rules_request(
            command_handle,
            submitter_did.as_ptr(),
            data.as_ptr(),
            cb,
...
/// # Returns
/// Request result as json.
pub async fn build_get_auth_rule_request(
    submitter_did: Option<&str>,
    txn_type: Option<&str>,
    action: Option<&str>,
    field: Option<&str>,
    ...
    let err = _build_get_auth_rule_request(
        command_handle,
        submitter_did,
        txn_type,
        action,
...
fn _build_get_auth_rule_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    txn_type: Option<&str>,
    action: Option<&str>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_auth_rule_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
...
/// # Returns
/// Request result as json.
pub async fn build_txn_author_agreement_request(
    submitter_did: &str,
    text: Option<&str>,
    version: &str,
    ...
    let err = _build_txn_author_agreement_request(
        command_handle,
        submitter_did,
        text,
        version,
...
fn _build_txn_author_agreement_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    text: Option<&str>,
    version: &str,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_txn_author_agreement_request(
            command_handle,
            submitter_did.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_disable_all_txn_author_agreements_request(
    submitter_did: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_disable_all_txn_author_agreements_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    cb: Option<ResponseStringCB>,
) -> ErrorCode {
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_disable_all_txn_author_agreements_request(
            command_handle,
            submitter_did.as_ptr(),
            cb,
        )
...
/// # Returns
/// Request result as json.
pub async fn build_get_txn_author_agreement_request(
    submitter_did: Option<&str>,
    data: Option<&str>,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_get_txn_author_agreement_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    data: Option<&str>,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_txn_author_agreement_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            opt_c_ptr!(data, data_str),
            cb,
...
/// # Returns
/// Request result as json.
pub async fn build_acceptance_mechanisms_request(
    submitter_did: &str,
    aml: &str,
    version: &str,
    ...
    let err = _build_acceptance_mechanisms_request(
        command_handle,
        submitter_did,
        aml,
        version,
...
fn _build_acceptance_mechanisms_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    aml: &str,
    version: &str,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_acceptance_mechanisms_request(
            command_handle,
            submitter_did.as_ptr(),
            aml.as_ptr(),
            version.as_ptr(),
...
/// # Returns
/// Request result as json.
pub async fn build_get_acceptance_mechanisms_request(
    submitter_did: Option<&str>,
    ...
    let err = _build_get_acceptance_mechanisms_request(
        command_handle,
        submitter_did,
        timestamp,
        version,
...
fn _build_get_acceptance_mechanisms_request(
    command_handle: CommandHandle,
    submitter_did: Option<&str>,
    timestamp: Option<i64>,
    version: Option<&str>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_acceptance_mechanisms_request(
            command_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            timestamp,
...
pub async fn append_txn_author_agreement_acceptance_to_request(
    request_json: &str,
    text: Option<&str>,
    version: Option<&str>,
    ...
    let err = _append_txn_author_agreement_acceptance_to_request(
        command_handle,
        request_json,
        text,
        version,
...
fn _append_txn_author_agreement_acceptance_to_request(
    command_handle: CommandHandle,
    request_json: &str,
    text: Option<&str>,
    version: Option<&str>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_append_txn_author_agreement_acceptance_to_request(
            command_handle,
            request_json.as_ptr(),
            opt_c_ptr!(text, text_str),
            opt_c_ptr!(version, version_str),
...
/// # Returns
/// Updated request result as json.
pub async fn append_request_endorser(
    request_json: &str,
    endorser_did: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _append_request_endorser(
    ...
    ErrorCode::from(unsafe {
        ledger::indy_append_request_endorser(
            command_handle,
            request_json.as_ptr(),
            endorser_did.as_ptr(),
            cb,
...
/// # Returns
/// Updated request result as json.
pub async fn build_ledgers_freeze_request(
    submitter_did: &str,
    ledgers_ids: Vec<u64>,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _build_ledgers_freeze_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    ledgers_ids: &str,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_ledgers_freeze_request(
            command_handle,
            submitter_did.as_ptr(),
            ledgers_ids.as_ptr(),
            cb,
...
///     ...
/// }
pub async fn build_get_frozen_ledgers_request(submitter_did: &str) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
    let err = _build_get_frozen_ledgers_request(command_handle, submitter_did, cb);
    ResultHandler::str(command_handle, err, receiver).await
}

fn _build_get_frozen_ledgers_request(
    command_handle: CommandHandle,
    submitter_did: &str,
    cb: Option<ResponseStringCB>,
) -> ErrorCode {
    ...
    ErrorCode::from(unsafe {
        ledger::indy_build_get_frozen_ledgers_request(command_handle, submitter_did.as_ptr(), cb)
    })
}
