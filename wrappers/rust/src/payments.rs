...
use ffi::payments;
use ffi::{
    CommandHandle, ResponseBoolCB, ResponseSliceCB, ResponseStringCB, ResponseStringI64CB,
    ResponseStringStringCB, WalletHandle,
};
...
fn _create_payment_address(
    ...
    ErrorCode::from(unsafe {
        payments::indy_create_payment_address(
            command_handle,
            wallet_handle,
...
pub async fn list_payment_addresses(wallet_handle: WalletHandle) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _add_request_fees(
    ...
    ErrorCode::from(unsafe {
        payments::indy_add_request_fees(
            command_handle,
            wallet_handle,
...
///   }]
pub async fn parse_response_with_fees(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _parse_response_with_fees(
    ...
    ErrorCode::from(unsafe {
        payments::indy_parse_response_with_fees(
            command_handle,
            payment_method.as_ptr(),
            resp_json.as_ptr(),
            cb,
...
#[deprecated(
    since = "2.0.0",
    note = "please use `parse_get_payment_sources_with_from_response` instead"
)]
pub async fn build_get_payment_sources_request(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    payment_address: &str,
) -> Result<(String, String), IndyError> {
    ...
    let err = _build_get_payment_sources_request(
        command_handle,
        wallet_handle,
        submitter_did,
        payment_address,
...
fn _build_get_payment_sources_request(
    command_handle: CommandHandle,
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    payment_address: &str,
    ...
    ErrorCode::from(unsafe {
        payments::indy_build_get_payment_sources_request(
            command_handle,
            wallet_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
...
/// * `get_utxo_txn_json` - Indy request for getting UTXO list for payment address
/// * `payment_method`
pub async fn build_get_payment_sources_with_from_request(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    payment_address: &str,
    from: Option<i64>,
    ...
    let err = _build_get_payment_sources_with_from_request(
        command_handle,
        wallet_handle,
        submitter_did,
        payment_address,
...
fn _build_get_payment_sources_with_from_request(
    command_handle: CommandHandle,
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    payment_address: &str,
    ...
    ErrorCode::from(unsafe {
        payments::indy_build_get_payment_sources_with_from_request(
            command_handle,
            wallet_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            payment_address.as_ptr(),
...
pub async fn parse_get_payment_sources_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _parse_get_payment_sources_response(
    command_handle: CommandHandle,
    payment_method: &str,
    resp_json: &str,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        payments::indy_parse_get_payment_sources_response(
            command_handle,
            payment_method.as_ptr(),
            resp_json.as_ptr(),
            cb,
...
pub async fn parse_get_payment_sources_with_from_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<(String, Option<i64>), IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string_i64();

    let err = _parse_get_payment_sources_with_from_response(
        command_handle,
        payment_method,
        resp_json,
        cb,
    ...
    ResultHandler::str_i64(command_handle, err, receiver)
        .await
        .map(|(s, i)| (s, if i >= 0 { Some(i) } else { None }))
}

fn _parse_get_payment_sources_with_from_response(
    command_handle: CommandHandle,
    payment_method: &str,
    resp_json: &str,
    ...
    ErrorCode::from(unsafe {
        payments::indy_parse_get_payment_sources_with_from_response(
            command_handle,
            payment_method.as_ptr(),
            resp_json.as_ptr(),
            cb,
...
/// * `payment_method`
pub async fn build_payment_req(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    inputs: &str,
    outputs: &str,
...
fn _build_payment_req(
    ...
    ErrorCode::from(unsafe {
        payments::indy_build_payment_req(
            command_handle,
            wallet_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            inputs.as_ptr(),
...
///      extra: <str>, // optional data from payment transaction
///   }]
pub async fn parse_payment_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _parse_payment_response(
    ...
    ErrorCode::from(unsafe {
        payments::indy_parse_payment_response(
            command_handle,
            payment_method.as_ptr(),
            resp_json.as_ptr(),
            cb,
...
pub async fn prepare_extra_with_acceptance_data(
    ...
    let err = _prepare_extra_with_acceptance_data(
        command_handle,
        extra_json,
        text,
        version,
...
fn _prepare_extra_with_acceptance_data(
    command_handle: CommandHandle,
    extra_json: Option<&str>,
    text: Option<&str>,
    version: Option<&str>,
    ...
    ErrorCode::from(unsafe {
        payments::indy_prepare_payment_extra_with_acceptance_data(
            command_handle,
...
pub async fn build_set_txn_fees_req(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    payment_method: &str,
    fees_json: &str,
    ...
    let err = _build_set_txn_fees_req(
        command_handle,
        wallet_handle,
        submitter_did,
        payment_method,
...
fn _build_set_txn_fees_req(
    ...
    ErrorCode::from(unsafe {
        payments::indy_build_set_txn_fees_req(
            command_handle,
            wallet_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            payment_method.as_ptr(),
...
pub async fn build_get_txn_fees_req(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    payment_method: &str,
) -> Result<String, IndyError> {
    ...
    let err = _build_get_txn_fees_req(
        command_handle,
        wallet_handle,
        submitter_did,
        payment_method,
...
fn _build_get_txn_fees_req(
    ...
    ErrorCode::from(unsafe {
        payments::indy_build_get_txn_fees_req(
            command_handle,
            wallet_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            payment_method.as_ptr(),
...
///   txnTypeN: amountN,
/// }
pub async fn parse_get_txn_fees_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _parse_get_txn_fees_response(
    command_handle: CommandHandle,
    payment_method: &str,
    resp_json: &str,
    cb: Option<ResponseStringCB>,
    ...
    ErrorCode::from(unsafe {
        payments::indy_parse_get_txn_fees_response(
            command_handle,
            payment_method.as_ptr(),
            resp_json.as_ptr(),
            cb,
...
pub async fn build_verify_payment_req(
    wallet_handle: WalletHandle,
    submitter_did: Option<&str>,
    receipt: &str,
) -> Result<(String, String), IndyError> {
...
fn _build_verify_req(
    ...
    ErrorCode::from(unsafe {
        payments::indy_build_verify_payment_req(
            command_handle,
            wallet_handle,
            opt_c_ptr!(submitter_did, submitter_did_str),
            receipt.as_ptr(),
...
pub async fn parse_verify_payment_response(
    payment_method: &str,
    resp_json: &str,
) -> Result<String, IndyError> {
    let (receiver, command_handle, cb) = ClosureHandler::cb_ec_string();
...
fn _parse_verify_response(
    ...
    ErrorCode::from(unsafe {
        payments::indy_parse_verify_payment_response(
            command_handle,
            payment_method.as_ptr(),
            resp_json.as_ptr(),
            cb,
...
pub async fn get_request_info(
    ...
    let err = _get_request_info(
        command_handle,
        get_auth_rule_resp_json,
        requester_info_json,
        fees_json,
        cb,
    );
...
fn _get_request_info(
    ...
    ErrorCode::from(unsafe {
        payments::indy_get_request_info(
            command_handle,
            get_auth_rule_resp_json.as_ptr(),
            requester_info_json.as_ptr(),
            fees_json.as_ptr(),
            cb,
        )
    })
...
pub async fn sign_with_address(
    wallet_handle: WalletHandle,
    address: &str,
    message: &[u8],
...
fn _sign_with_address(
    ...
    ErrorCode::from(unsafe {
        payments::indy_sign_with_address(
            command_handle,
            wallet_handle,
            address.as_ptr(),
...
fn _verify_with_address(
    ...
    ErrorCode::from(unsafe {
        payments::indy_verify_with_address(
            command_handle,
            address.as_ptr(),
            message.as_ptr() as *const u8,
            message.len() as u32,
